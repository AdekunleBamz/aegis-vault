# Contract Preflight Note

- Run clarinet check and tests before deployments.
- Use `npm run check` at repo root as the aggregated preflight command.
- Verify all contract constants match the docs and UI labels.
