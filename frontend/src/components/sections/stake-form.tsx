            ...
            <form onSubmit={handleStake} className="space-y-8" aria-label="Stake STX in Aegis Vault">
              ...
              <div className="rounded-[36px] border border-border/40 bg-background/40 p-4 sm:p-5">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                  <div className="px-2">
                    ...
                    <p id="stake-amount-help" className="mt-2 text-sm text-muted-foreground">
                  ...
                  <button
                    ...
                    className="self-start rounded-full border border-aegis-blue/30 bg-aegis-blue/10 px-4 py-2 text-[10px] font-black uppercase tracking-widest text-aegis-blue transition-colors hover:text-aegis-cyan focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aegis-blue/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                  >
                    Use Max Balance
                  </button>
                </div>
                  ...
                  <div className="mt-4 flex flex-wrap gap-2 px-1">
                    {quickAmounts.map((preset) => (
                      <button
                        ...
                        className="rounded-full border border-border/50 bg-background/60 px-4 py-2 text-xs font-black uppercase tracking-widest text-muted-foreground transition-all hover:border-aegis-blue/40 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aegis-blue/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                      >
                        {preset.label}
                      </button>
                    ))}
              ...
              <div className="rounded-[32px] border border-border/40 bg-background/30 p-4">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-aegis-blue to-aegis-purple opacity-0 group-hover:opacity-100 transition-opacity duration-700" aria-hidden="true" />
                </button>
              </div>
 
              <div className="flex items-center justify-center gap-8 pt-4" role="list">
                <div className="flex items-center gap-2 text-[10px] font-bold text-muted-foreground/40 uppercase tracking-tighter" role="listitem" aria-label="Lock period indicator">
