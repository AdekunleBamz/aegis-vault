        ...
        <div className="flex-1 min-w-0">
          ...
          {toast.action && (
            <button
              ...
              className="mt-2 text-sm font-medium underline hover:no-underline rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70"
            >
              {toast.action.label}
            </button>
          )}
